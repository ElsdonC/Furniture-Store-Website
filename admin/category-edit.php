                        ...
                        <form action="code.php" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <textarea name="meta_description" required class="form-control"><?= $row['meta_description'] ?></textarea>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="">Meta Keyword</label>
                                    <textarea name="meta_keyword" required class="form-control"><?= $row['meta_keyword'] ?></textarea>
                                </div>
                                <div class="col-md-6 mb-3">
