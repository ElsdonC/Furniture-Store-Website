...
if(isset($_POST['post_add'])) {
    ...
    $query = "INSERT INTO posts (category_id,name,slug,description,image,meta_title,meta_description,meta_keyword,status) VALUES 
                ('$category_id','$name','$slug','$description','$image','$filename','$meta_title','$meta_keyword','$status')";
    $query_run = mysqli_query($con, $query);
...
if(isset($_POST['category_update'])) {
    ...
    $query = "UPDATE categories SET name='$name',slug='$slug',description='$description',meta_title='$meta_title',meta_keyword='$meta_keyword',navbar_status='$navbar_status',status='$status'
